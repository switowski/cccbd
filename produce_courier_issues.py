...
Script to create the main record for a CERN Courier (and eventually
CERN Bulletin) issue considering the hierarchy of files (and existing
files) as returned by the scanning company (they have provided the
XMLs for each scanned article, but not for the whole issue, even
though they have scanned the whole issue).
"""
